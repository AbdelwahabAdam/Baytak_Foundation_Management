...
const arabic: Record<string, string> = {
  ...
  'Tasks': 'المهام',
  'المهام': 'المهام',
  'Work assignments': 'تكليفات العمل',
  'Assign work to users, filter by assignee or date range, and track progress.': 'كلّف المستخدمين بمهام، وصفِّ حسب المستخدم أو الفترة الزمنية، وتابع التقدم.',
  'View your assigned tasks and update their status.': 'اعرض المهام المسندة إليك وحدّث حالتها.',
  'Assign task': 'إسناد مهمة',
  'Assigned user': 'المستخدم المسند',
  'All users': 'كل المستخدمين',
  'Title or description': 'العنوان أو الوصف',
  'No tasks found': 'لا توجد مهام',
  'Assign a task to a user to get started.': 'أسند مهمة إلى مستخدم للبدء.',
  'No tasks are assigned to you yet.': 'لا توجد مهام مسندة إليك بعد.',
